...
def upload_text_file(drive, folder_id: str, name: str, content: str, mime_type: str = "text/plain") -> str:
    tmp_dir = Path.cwd() / ".jobbot-upload-tmp"
    tmp_dir.mkdir(exist_ok=True)
    file_path = tmp_dir / name
    file_path.write_text(content, encoding="utf-8")
    return upload_file(drive, folder_id, file_path, mime_type=mime_type)
